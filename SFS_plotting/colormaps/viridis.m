function m = viridis(n)
%VIRIDIS   Blue-green-yellow color map from matplotlib
%
%   Usage: m = viridis(n)
%
%   Input parameters:
...
%       m - colormap
%
%   VIRIDIS(N) returns an N-by-3 matrix containing a divergent colormap.
...
%% ===== Computation =====================================================
table = 256 * [0.267004, 0.004874, 0.329415
