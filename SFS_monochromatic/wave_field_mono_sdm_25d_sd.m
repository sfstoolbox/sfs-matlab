function [x,y,P] = wave_field_mono_sdm_25_sd(X,Y,xs,L,f,src,conf)
%WAVE_FIELD_MONO_SDM_25D_SD simulates a wave field for 2.5D NFC-HOA IN THE
%SPATIAL DOMAIN
%
%   Usage: [x,y,P] = wave_field_mono_sdm_25d_sd(X,Y,xs,L,f,src,[conf])
%
%   Input parameters:
%       X           - [xmin,xmax]
%       Y           - [ymin,ymax]
...
%
%   WAVE_FIELD_MONO_SDM_25D_SD(X,Y,xs,L,f,src,conf) simulates a wave
