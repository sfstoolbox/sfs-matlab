function D = driving_function_mono_nfchoa_ls(x0,xs,f,conf)
%DRIVING_FUNCTION_MONO_NFCHOA_LS returns the driving signal D for a line source
%in NFCHOA
%
%   Usage: D = driving_function_mono_nfchoa_ls(x0,xs,f,[conf])
%
%   Input parameters:
...
%
%   DRIVING_FUNCTION_MONO_NFCHOA_LS(x0,xs,f,conf) returns NFCHOA driving
