function cmd = gp_print_png(p)
%GP_PRINT_PNG returns the gnuplot command to print to png
%
...
%% ===== Main ============================================================
% converts the size to pixel
if strcmp('cm',p.size_unit)
    p.size = cm2px(p.size);
elseif strcmp('in',p.size_unit);
    p.size = in2px(p.size);
end
...
'set t pngcairo size %f,%f enhanced font ''Verdana,14'';\n', ...
'set output ''%s'';\n', ...
