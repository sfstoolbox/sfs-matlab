function fabianpintaraw2mat(irsset,irspath)
%FABIANPINTARAW2MAT converts BRIRs from FABIAN in Pinta to our mat-file based format
%
%   Usage: fabianpintaraw2mat(irsset,irspath);
%
%   Input options:
...
%
%   FABIANPINTARAW2MAT(irsset,irspath) converts the IRs data given by the irsset
