...
# which means if you like to have some colors, use something like this
...
# The if-else condition is broken by the call command. Therefore we need the if
# condition again for the else part
if (LSdist<=0.1) set yrange[ymin+0.1:ymax]
