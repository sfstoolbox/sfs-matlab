...
conf.xref = [0,0,0];    % reference point
% Plane wave
src = 'pw';             % virtual source type
xs = [0,1,0];           % coordinates of virtual source
...
title('WFS 3D circular array, plane wave [0,1,0], impulse response');