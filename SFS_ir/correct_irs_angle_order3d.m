function irs = correct_irs_angle_order3d(irs,conf)
...
% ===== CHANGE ============================================================
[phi,idx] = sort(irs.apparent_azimuth);
irs.apparent_azimuth = repmat(phi,1,180);


irs.apparent_elevation =  repmat(irs.apparent_elevation,1,360); 
[irs.apparent_elevation,idx2] = sort(irs.apparent_elevation);
% =========================================================================

irs.left = irs.left(:,repmat(idx,180,1));
irs.right = irs.right(:,repmat(idx,180,1));
