...
xs = [0.5,1];
% mono-frequent
[x,y,P_wfs2d_linear_pw,x0,win] = ...
    wave_field_mono_wfs_2d(X,Y,xs,src,f,L,conf);
...
xs = [0.5,1];
% mono-frequent
[x,y,P_wfs2d_circular_pw,x0,win] = ...
    wave_field_mono_wfs_2d(X,Y,xs,src,f,L,conf);
...
xs = [0.5,2];
% mono-frequent
[x,y,P_wfs2d_circular_ps,x0,win] = ...
    wave_field_mono_wfs_2d(X,Y,xs,src,f,L,conf);
...
xs = [0.5,0.5];
% mono-frequent
[x,y,P_wfs2d_circular_fs,x0,win] = ...
    wave_field_mono_wfs_2d(X,Y,xs,src,f,L,conf);
...
xs = [0.5,1];
% mono-frequent
[x,y,P_wfs25d_circular_pw,x0,win] = ...
    wave_field_mono_wfs_25d(X,Y,xs,src,f,L,conf);
...
xs = [0.5,2];
% mono-frequent
[x,y,P_wfs25d_circular_ps,x0,win] = ...
    wave_field_mono_wfs_25d(X,Y,xs,src,f,L,conf);
...
xs = [0.5,0.5];
% mono-frequent
[x,y,P_wfs25d_circular_fs,x0,win] = ...
    wave_field_mono_wfs_25d(X,Y,xs,src,f,L,conf);
...
xs = [0.5,1];
% mono-frequent
[x,y,P_wfs25d_box_pw,x0,win] = wave_field_mono_wfs_25d(X,Y,xs,src,f,L,conf);
title('WFS 2.5D box shaped array, plane wave [0.5,1], mono-frequent');
% spatio-temporal impulse response
[x,y,p_wfs25d_box_pw,x0,win] = wave_field_imp_wfs_25d(X,Y,xs,src,t,L,conf);
title('WFS 2.5D box shaped array, plane wave [0.5,1], impulse response');
% point source
src = 'ps';
xs = [0.5,2];
% mono-frequent
[x,y,P_wfs25d_box_ps,x0,win] = wave_field_mono_wfs_25d(X,Y,xs,src,f,L,conf);
title('WFS 2.5D box shaped array, point source [0.5,2], mono-frequent');
% spatio-temporal impulse response
[x,y,p_wfs25d_box_ps,x0,win] = wave_field_imp_wfs_25d(X,Y,xs,src,t,L,conf);
title('WFS 2.5D box shaped array, point source [0.5,2], impulse response');
% Focused source
src = 'fs';
xs = [0.5,0.5];
% mono-frequent
[x,y,P_wfs25d_box_fs,x0,win] = wave_field_mono_wfs_25d(X,Y,xs,src,f,L,conf);
title('WFS 2.5D box shaped array, focused source [0.5,0.5], mono-frequent');
% spatio-temporal impulse response
[x,y,p_wfs25d_box_fs,x0,win] = wave_field_imp_wfs_25d(X,Y,xs,src,t,L,conf);
...
% spatio-temporal impulse response
[x,y,p_nfchoa25d_circular_ps,x0] = wave_field_imp_nfchoa_25d(X,Y,xs,src,t,L,conf);
