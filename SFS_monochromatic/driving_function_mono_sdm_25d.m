function [Dkx] = driving_function_mono_sdm_25d(kx,xs,f,src,conf)
%DRIVING_FUNCTION_MONO_SDM_25D returns the driving signal D for 2.5D SDM
%
%   Usage: Dkx = driving_function_mono_sdm_25d(kx,xs,f,src,[conf])
%
%   Input parameters:
...
%   The driving signal is calculated for the SDM 2.5 dimensional case.
