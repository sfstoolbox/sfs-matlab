function D = driving_function_mono_nfchoa_fs(x0,xs,f,conf)
%DRIVING_FUNCTION_MONO_NFCHOA_FS returns the driving signal D for a focused source
%in NFCHOA
%
%   Usage: D = driving_function_mono_nfchoa_fs(x0,xs,f,[conf])
%
%   Input parameters:
...
%
%   DRIVING_FUNCTION_MONO_NFCHOA_FS(x0,xs,f,conf) returns NFCHOA driving
